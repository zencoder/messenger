...
class Messenger::JabberTest < Test::Unit::TestCase
  ...
  context "Jabber notification" do
    ...
    should "send a successful jabber message" do
      ...
      result = Messenger::Jabber.deliver("jabber://brandon@zencoder.com", "Test message", :jabber_id => "notifier@zencoder.com", :jabber_password => "asdfasdf")
    ...
    should "determine and set the jabber host" do
      ...
      result = Messenger::Jabber.deliver("jabber://brandon@zencoder.com/host.com", "Test message", :jabber_id => "notifier@zencoder.com", :jabber_password => "asdfasdf")
      assert result.success?
      assert_nil result.response
    end
    ...
    should "raise when sending to an invalid URL" do
      assert_raises Messenger::URLError do
        Messenger::Jabber.deliver("jabber://", :jabber_id => "asdf", :jabber_password => "asdf")
      end
    end

    should "obfuscate the URL" do
      assert_equal "jabber://test@example.com", Messenger::Jabber.obfuscate("jabber://test@example.com")
    end

    should "raise when obfuscating an invalid URL" do
      assert_raises Messenger::URLError do
        Messenger::Jabber.obfuscate("jabber://")
      end
    end
  end
  ...
  context "Jabber URL validation" do
    ...
    should "return false for bad URLs" do
      assert_equal false, Messenger::Jabber.valid_url?("jabber://!")
      assert_equal false, Messenger::Jabber.valid_url?("jabber://test")
      assert_equal false, Messenger::Jabber.valid_url?("jabber://example.com")
    end
  end
